...
class ContactForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'document': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Apenas números'}),
...
AddressFormSet = inlineformset_factory(
    ...
    fields=('street', 'number', 'complement', 'neighborhood', 'city', 'state', 'zip_code'), # Campos a exibir
